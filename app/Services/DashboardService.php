...
class DashboardService
{
    public function getDashboardStats()
    {
        ...
        return [
            ...
            'dataPosts7Days' => $dataPosts7Days,
            'labels6Months' => $labels6Months,
            'dataUsers6Months' => $dataUsers6Months,
            'interactionData' => $interactionData,
            'userStatusData' => $userStatusData,
            'engagementTrendData' => $engagementTrendData,
            'topPostsLabels' => $topPostsLabels,
            ...
            'peakActivityLabels' => $peakActivityLabels,
